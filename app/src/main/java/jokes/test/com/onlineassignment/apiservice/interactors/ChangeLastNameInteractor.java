 ...
 * This call network call for Change the name api
 */
public class ChangeLastNameInteractor extends ApiInteractor {
    ...
    /**
     * Initialize Data
     * @param config api config variable
     */
    public ChangeLastNameInteractor(ApiConfig config) {
        this.config = (ApiConfig) config;
    }


    /**
     * Load Retrofit Instance with name data
    ...
    public void execute() {
        ...
        call = syncInstance.requestChangingTheLastNameApi(config.firstName,config.lastName);
